                    ...
                    @if($categories->isNotEmpty())
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            @foreach($categories as $category)
                                <div class="flex fex-col items-center bg-white border border-gray-200rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 relative">
                                    <img
