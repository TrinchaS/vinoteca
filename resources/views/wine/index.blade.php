                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if($wines->isNotEmpty())
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            ...
                            <div class="flex fex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 relative">
                                    ...
                                    <div class="flex flex-col p-4 leading-normal">
                                        ...
                                        <div class="absolute bottom-0 right-0 p-4 flex justify-betewwn">
                                            <a 
                                            ...
                                            <form action="{{ route('wines.destroy', $wine) }}" method="POST">
                                                ...
                                                <button
                                                    type="submit"
                                                    class="bg-red-500 hover:bg-red-700 text-white font-blod p-1 rounded w-full md:w-auto ms-2"
                                                    >
                                                        Eliminar
                                                </button>
                                            </form>
